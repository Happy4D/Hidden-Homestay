...
def run():
    ...
    with sync_playwright() as p:
        ...
        check('address shown (Road 777)', '777' in page.locator('.loc-addr').inner_text() and 'Russey Keo' in page.locator('.loc-addr').inner_text())
        ...
        page.screenshot(path=str(SHOTS / '02-home-khmer.png'))
        page.click('#langEn')
        ...
        page.screenshot(path=str(SHOTS / '03-success.png'))
        ...
        page.screenshot(path=str(SHOTS / '04-overnight-success.png'))
        ...
        mp.screenshot(path=str(SHOTS / '05-mobile-home.png'))
        mp.close()
